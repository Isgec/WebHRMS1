...
Namespace SIS.HRM
  ...
  Partial Public Class taCategories
    ...
    Public Shared Function taCategoriesSelectList(ByVal OrderBy As String) As List(Of SIS.HRM.taCategories)
      Dim Results As List(Of SIS.HRM.taCategories) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          _RecordCount = -1
          Results = New List(Of SIS.HRM.taCategories)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.HRM.taCategories(Reader))
          End While
          Reader.Close()
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function taCategoriesGetNewRecord() As SIS.HRM.taCategories
      Return New SIS.HRM.taCategories()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function taCategoriesGetByID(ByVal CategoryID As Int32) As SIS.HRM.taCategories
      Dim Results As SIS.HRM.taCategories = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.HRM.taCategories(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function taCategoriesSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.HRM.taCategories)
      Dim Results As List(Of SIS.HRM.taCategories) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Shared Function SelecttaCategoriesAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          End If
          While (Reader.Read())
            Dim Tmp As SIS.HRM.taCategories = New SIS.HRM.taCategories(Reader)
