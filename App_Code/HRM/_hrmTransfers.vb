...
Namespace SIS.HRM
  ...
  Partial Public Class hrmTransfers
    ...
    Public Sub New(ByVal Reader As SqlDataReader)
      ...
      End If
      _C_DesignationIDHRM_Designations = New SIS.HRM.hrmDesignations("HRM_Designations1",Reader)
      _C_CompanyIDHRM_Companies = New SIS.HRM.hrmCompanies("HRM_Companies2",Reader)
      _C_DivisionIDHRM_Divisions = New SIS.HRM.hrmDivisions("HRM_Divisions3",Reader)
      _C_OfficeIDHRM_Offices = New SIS.HRM.hrmOffices("HRM_Offices4",Reader)
      _C_DepartmentIDHRM_Departments = New SIS.HRM.hrmDepartments("HRM_Departments5",Reader)
      _C_ProjectSiteIDDCM_Projects = New SIS.HRM.hrmProjects("DCM_Projects6",Reader)
      _U_CompanyIDHRM_Companies = New SIS.HRM.hrmCompanies("HRM_Companies7",Reader)
      _U_DivisionIDHRM_Divisions = New SIS.HRM.hrmDivisions("HRM_Divisions8",Reader)
      _U_OfficeIDHRM_Offices = New SIS.HRM.hrmOffices("HRM_Offices9",Reader)
      _U_DepartmentIDHRM_Departments = New SIS.HRM.hrmDepartments("HRM_Departments10",Reader)
