...
Namespace SIS.HRM
  ...
  Partial Public Class newHrmEmployees
    ...
    Private _FK_HRM_Employees_SiteAllowanceApprover As SIS.HRM.newHrmEmployees = Nothing
    Private _FK_HRM_Employees_VerifierID As SIS.HRM.newHrmEmployees = Nothing
    Private _FK_HRM_Employees_ApproverID As SIS.HRM.newHrmEmployees = Nothing
    Private _FK_HRM_Employees_TAVerifier As SIS.HRM.newHrmEmployees = Nothing
    Private _FK_HRM_Employees_TAApprover As SIS.HRM.newHrmEmployees = Nothing
    Private _FK_HRM_Employees_TASanctioningAuthority As SIS.HRM.newHrmEmployees = Nothing
    ...
    Public ReadOnly Property FK_HRM_Employees_HRM_Divisions() As SIS.HRM.hrmDivisions
      ...
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_SiteAllowanceApprover() As SIS.HRM.newHrmEmployees
      Get
        If _FK_HRM_Employees_SiteAllowanceApprover Is Nothing Then
          _FK_HRM_Employees_SiteAllowanceApprover = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(_SiteAllowanceApprover)
        End If
        Return _FK_HRM_Employees_SiteAllowanceApprover
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_VerifierID() As SIS.HRM.newHrmEmployees
      Get
        If _FK_HRM_Employees_VerifierID Is Nothing Then
          _FK_HRM_Employees_VerifierID = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(_VerifierID)
        End If
        Return _FK_HRM_Employees_VerifierID
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_ApproverID() As SIS.HRM.newHrmEmployees
      Get
        If _FK_HRM_Employees_ApproverID Is Nothing Then
          _FK_HRM_Employees_ApproverID = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(_ApproverID)
        End If
        Return _FK_HRM_Employees_ApproverID
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_TAVerifier() As SIS.HRM.newHrmEmployees
      Get
        If _FK_HRM_Employees_TAVerifier Is Nothing Then
          _FK_HRM_Employees_TAVerifier = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(_TAVerifier)
        End If
        Return _FK_HRM_Employees_TAVerifier
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_TAApprover() As SIS.HRM.newHrmEmployees
      Get
        If _FK_HRM_Employees_TAApprover Is Nothing Then
          _FK_HRM_Employees_TAApprover = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(_TAApprover)
        End If
        Return _FK_HRM_Employees_TAApprover
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_TASanctioningAuthority() As SIS.HRM.newHrmEmployees
      Get
        If _FK_HRM_Employees_TASanctioningAuthority Is Nothing Then
          _FK_HRM_Employees_TASanctioningAuthority = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(_TASanctioningAuthority)
        End If
    ...
    Public ReadOnly Property FK_HRM_Employees_HRM_Offices() As SIS.HRM.hrmOffices
      ...
      End Get
    End Property
    Public ReadOnly Property FK_HRM_C_ProjectSiteID() As SIS.HRM.hrmProjects
      Get
        If _FK_HRM_C_ProjectSiteID Is Nothing Then
          _FK_HRM_C_ProjectSiteID = SIS.HRM.hrmProjects.GetByID(_C_ProjectSiteID)
        End If
        Return _FK_HRM_C_ProjectSiteID
      End Get
    End Property
    Public ReadOnly Property FK_HRM_Employees_CategoryID() As SIS.HRM.taCategories
      Get
        If _FK_HRM_Employees_CategoryID Is Nothing Then
          _FK_HRM_Employees_CategoryID = SIS.HRM.taCategories.taCategoriesGetByID(_CategoryID)
        End If
        Return _FK_HRM_Employees_CategoryID
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function newHrmEmployeesSelectList(ByVal OrderBy As String) As List(Of SIS.HRM.newHrmEmployees)
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function newHrmEmployeesGetNewRecord() As SIS.HRM.newHrmEmployees
      Return New SIS.HRM.newHrmEmployees()
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function newHrmEmployeesGetByID(ByVal CardNo As String) As SIS.HRM.newHrmEmployees
      Dim Results As SIS.HRM.newHrmEmployees = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.HRM.newHrmEmployees(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)>
    Public Shared Function newHrmEmployeesGetByID(ByVal CardNo As String, ByVal Filter_CardNo As String, ByVal Filter_C_OfficeID As Int32, ByVal Filter_C_DepartmentID As String, ByVal Filter_C_DesignationID As Int32, ByVal Filter_CategoryID As Int32) As SIS.HRM.newHrmEmployees
      Return newHrmEmployeesGetByID(CardNo)
    End Function
    <DataObjectMethod(DataObjectMethodType.Insert, True)>
    Public Shared Function newHrmEmployeesInsert(ByVal Record As SIS.HRM.newHrmEmployees) As SIS.HRM.newHrmEmployees
      Dim _Rec As SIS.HRM.newHrmEmployees = SIS.HRM.newHrmEmployees.newHrmEmployeesGetNewRecord()
      With _Rec
    ...
    End Function
    Public Shared Function InsertData(ByVal Record As SIS.HRM.newHrmEmployees) As SIS.HRM.newHrmEmployees
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Shared Function newHrmEmployeesUpdate(ByVal Record As SIS.HRM.newHrmEmployees) As SIS.HRM.newHrmEmployees
      Dim _Rec As SIS.HRM.newHrmEmployees = SIS.HRM.newHrmEmployees.newHrmEmployeesGetByID(Record.CardNo)
      With _Rec
        .EmployeeName = Record.EmployeeName
        .C_DivisionID = Record.C_DivisionID
        .C_OfficeID = Record.C_OfficeID
    ...
    End Function
    Public Shared Function UpdateData(ByVal Record As SIS.HRM.newHrmEmployees) As SIS.HRM.newHrmEmployees
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Shared Function newHrmEmployeesDelete(ByVal Record As SIS.HRM.newHrmEmployees) As Int32
    ...
    Public Shared Function SelectnewHrmEmployeesAutoCompleteList(ByVal Prefix As String, ByVal count As Integer, ByVal contextKey As String) As String()
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          End If
          While (Reader.Read())
            Dim Tmp As SIS.HRM.newHrmEmployees = New SIS.HRM.newHrmEmployees(Reader)
