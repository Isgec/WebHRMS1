<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_hrmNewJoinings.aspx.vb" Inherits="AF_hrmNewJoinings" title="Add: New Joining" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaApprovalWFTypes" runat="server" Text="&nbsp;Add: New Joining"></asp:Label>
</div>
    ...
    <div id="frmdiv" class="ui-widget-content minipage">
		<table>
            ...
            WatermarkText="[Enter Card No]"
						TargetControlID="TextBoxCardNo" />
					<asp:RequiredFieldValidator 
						ID = "RequiredFieldValidatorCardNo"
						runat = "server"
						ControlToValidate = "TextBoxCardNo"
      ...
      <tr>
        ...
        <td style="Padding-top: 15px;">
          <LGM:LC_hrmStatus
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="Label1" runat="server" Text="Contractual :" /></b>
				</td>
				<td>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="Label2" runat="server" Text="E-Mail ID :" /></b>
				</td>
				<td>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="Label3" runat="server" Text="Mobile No :" /></b>
				</td>
				<td>
...
<asp:ObjectDataSource 
  ...
  runat = "server" >
<SelectParameters>
  <asp:QueryStringParameter DefaultValue="0" Name="CardNo" QueryStringField="Code" Type="String" />
</SelectParameters>
<InsertParameters>
  <asp:Parameter Name="CardNo" Type="String" Direction="Output" />
</InsertParameters>
</asp:ObjectDataSource>
</div>
</div>
