<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_hrmTransfersHistorySite.aspx.vb" Inherits="EF_hrmTransfersHistorySite" title="Edit: Process Transfers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
  <div id="div1" class="ui-widget-content page">
    <div id="div2" class="caption">
      <asp:Label ID="LabeltaApprovalWFTypes" runat="server" Text="&nbsp;Edit: Process Transfers [Site]"></asp:Label>
    </div>
...
<asp:FormView ID="FormView1"
	...
	<EditItemTemplate>
		...
		<table>
			<tr>
				<td class="alignright">
					<b><asp:Label ID="Label1" runat="server" ForeColor="Red" Text="Create Event :" /></b>
				</td>
        <td>
          <asp:Label ID="Label2" runat="server" ForeColor="Red" Text='<%# Bind("CreateEvent") %>'></asp:Label>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="LabelTransferID" runat="server" Text="TransferID :" /></b>
				</td>
				<td>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="LabelCardNo" runat="server" Text="CardNo :" /></b>
				</td>
        <td>
          ...
          <asp:Label ID="TextCardNoHidden" style="display:none" runat="server" Text='<%# Bind("CardNo") %>'></asp:Label>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="LabelCompanyID" runat="server" Text="Company :" /></b>
				</td>
        <td>
          ...
          <asp:Label ID="TextCompanyIDHidden" style="display:none" runat="server" Text='<%# Bind("CompanyID") %>'></asp:Label>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="LabelDivisionID" runat="server" Text="Division :" /></b>
				</td>
        <td>
        ...
        <td>
          ...
          <asp:Label ID="TextDepartmentIDHidden" style="display:none" runat="server" Text='<%# Bind("DepartmentID") %>'></asp:Label>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="LabelProjectSiteID" runat="server" Text="Project Site :" /></b>
				</td>
        <td>
          <asp:Label ID="TextProjectSiteID" runat="server" Text='<%# Bind("ProjectSiteID") %>'></asp:Label>
			...
			<tr>
				<td class="alignright">
					<b><asp:Label ID="LabelTransferedOn" runat="server" Text="Transfered On :" /></b>
				</td>
        <td>
...
<asp:ObjectDataSource 
  ...
  runat = "server" >
<SelectParameters>
  <asp:QueryStringParameter DefaultValue="0" QueryStringField="Code" Name="TransferID" Type="Int32" />
</SelectParameters>
<UpdateParameters>
