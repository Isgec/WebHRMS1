<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_hrmEmployeesGeneral.aspx.vb" Inherits="GF_hrmEmployeesGeneral" title="Maintain List: Employees Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaBH" runat="server" Text="&nbsp;List: Employees Master"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      SearchContext = "hrmEmployeesGeneral"
      EditUrl = "~/HRM_Main/App_Edit/EF_hrmEmployeesGeneral.aspx"
      AddUrl = "~/HRM_Main/App_Create/AF_hrmEmployeesGeneral.aspx"
      runat = "server" />
    ...
    <asp:GridView ID="GridView1" runat="server" SkinID="gv_silver" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="CardNo">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Present Company" SortExpression="HRM_Companies1_Description">
          <ItemTemplate>
             <asp:Label ID="LabelC_CompanyID" runat="server" Text='<%# Eval("C_CompanyIDHRM_Companies.Description") %>'></asp:Label>
          </ItemTemplate>
          <HeaderStyle Width="100px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Present Department" SortExpression="HRM_Departments4_Description">
          <ItemTemplate>
             <asp:Label ID="LabelC_DepartmentID" runat="server" Text='<%# Eval("C_DepartmentIDHRM_Departments.Description") %>'></asp:Label>
          </ItemTemplate>
          <HeaderStyle Width="100px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Present Designation" SortExpression="HRM_Designations6_Description">
          <ItemTemplate>
