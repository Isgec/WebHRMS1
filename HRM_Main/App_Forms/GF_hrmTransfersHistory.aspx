<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_hrmTransfersHistory.aspx.vb" Inherits="GF_hrmTransfersHistory" title="Maintain List: Process Transfers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaBH" runat="server" Text="&nbsp;List: Process Transfers"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      EditUrl = "~/HRM_Main/App_Edit/EF_hrmTransfersHistory.aspx"
      AddUrl = "~/HRM_Main/App_Create/AF_hrmTransfersHistory.aspx"
      runat = "server" />
    ...
    <asp:GridView ID="GridView1" runat="server" SkinID="gv_silver" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="TransferID">
      <Columns>
        <asp:TemplateField>
          <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Transfer ID" SortExpression="TransferID">
          <ItemTemplate>
