Partial Class GF_hrmConfirmations
  ...
  Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim cardno As String = GridView1.DataKeys(e.CommandArgument).Values("CardNo")
        Dim RedirectUrl As String = ToolBar0_1.EditUrl & "?CardNo=" & cardno
