Partial Class GF_hrmDepartments
  ...
  Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim DepartmentID As String = GridView1.DataKeys(e.CommandArgument).Values("DepartmentID")
        Dim RedirectUrl As String = ToolBar0_1.EditUrl & "?Code=" & DepartmentID
