...
<asp:UpdatePanel ID="UPNLnewHrmEmployees" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/HRM_Main/App_Edit/EF_newHrmEmployees.aspx"
      AddUrl = "~/HRM_Main/App_Create/AF_newHrmEmployees.aspx"
    ...
    <asp:ObjectDataSource 
      ...
      runat = "server"
      DataObjectTypeName = "SIS.HRM.newHrmEmployees"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "UZ_newHrmEmployeesSelectList"
      TypeName = "SIS.HRM.newHrmEmployees"
