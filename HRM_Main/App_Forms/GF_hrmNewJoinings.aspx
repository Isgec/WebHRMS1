<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_hrmNewJoinings.aspx.vb" Inherits="GF_hrmNewJoinings" title="Maintain List: New Joining" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaBH" runat="server" Text="&nbsp;List: New Joining"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      SearchContext = "hrmNewJoinings"
  EditUrl = "~/HRM_Main/App_Edit/EF_hrmNewJoinings.aspx"
  AddUrl = "~/HRM_Main/App_Create/AF_hrmNewJoinings.aspx"
      runat = "server" />
