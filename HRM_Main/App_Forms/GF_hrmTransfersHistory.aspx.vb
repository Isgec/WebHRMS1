Partial Class GF_hrmTransfersHistory
  ...
  Private Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
    If e.CommandName.ToLower = "lgedit".ToLower Then
      Try
        Dim Code As String = GridView1.DataKeys(e.CommandArgument).Values("TransferID")
        Dim RedirectUrl As String = ToolBar0_1.EditUrl & "?TransferID=" & Code
